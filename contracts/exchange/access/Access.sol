...
contract Access is Initializable, OwnableUpgradeable, AccessControlUpgradeable {
    bytes32 public constant ADMIN_GENERAL_ROLE =
        keccak256(abi.encodePacked(Role.ADMIN_GENERAL));
