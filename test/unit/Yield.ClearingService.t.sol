...
contract YieldClearingServiceTest is Test {
    ...
    function test_swapYieldAsset_depositVault_succeeds() public {
        vm.prank(admin);
        clearingService.addYieldAsset(token, vault);
        ...
        clearingService.swapYieldAsset(params);
    ...
    function test_swapYieldAsset_redeemVault_succeeds() public {
        vm.prank(admin);
        clearingService.addYieldAsset(token, vault);
    ...
    function test_swapYieldAsset_revertsIfUnauthorized() public {
        ISwap.SwapParams memory params;
    ...
    function test_innerSwapYieldAsset_revertsIfCallerNotClearingService() public {
        address account;
        address assetIn;
        uint256 amountIn;
        address assetOut;
